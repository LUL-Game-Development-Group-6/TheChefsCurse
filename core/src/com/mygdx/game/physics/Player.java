...
public class Player extends DynamicObject {
    ...
    // Bullet code
    private final LinkedList<Bullet> ammunition = new LinkedList<>(); // Bullet code
    ...
    private final Sound playerHit = Gdx.audio.newSound(Gdx.files.internal(SoundPaths.PLAYERHIT_PATH));
    ...
    public void flipAnimationDynamic(Vector3 cursorvector) {
    ...
    public void render(SpriteBatch batch, FoodGame game, OrthographicCamera camera) {
        ...
        flipAnimationDynamic(cursorVector);
     ...
     * @since 1.0
     */
    public void bulletDirection(float offset, FoodGame game) {
