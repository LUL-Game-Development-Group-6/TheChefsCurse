...
public class Furniture extends DynamicObject
{
    ...
    public enum FurnitureType {
        // Kitchen
        FRIDGE (new Texture("objects/Utensils/Fridge.png"), 150, 300),
        STOVE (new Texture("objects/Utensils/Stove.png")),
        METAL_TABLE (new Texture("objects/Metal_Table/Table_1.png"), 1000, 700),
        CHAIR1 (new Texture("objects/Chairs/Chair_1.png"), 400, 500),
        CHAIR2 (new Texture("objects/Chairs/Chair_2.png"), 500, 400),
        // Freezer
        SINGLE_SHELF (new Texture("objects/freezer_shelves/shelf_1.png"), 400, 700),
        DOUBLE_SHELF (new Texture("objects/freezer_shelves/shelf_2.png")),
        LONG_SHELF (new Texture("objects/freezer_shelves/shelf_3.png")),
        ICE (new Texture("objects/ice/ice.png"), 400, 350),
        BOX (new Texture("objects/box/box.png"), 600, 400),
        // Restaurant
